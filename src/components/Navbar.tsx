    ...
    >
      <div className="w-full h-full flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-5">
          ...
          <button
            className=" px-1 py-0.5 md:py-1 md:px-2 text-white rounded-md text-sm md:text-lg border bg-secondary"
            onClick={() => {
              setCurrentLanguage(
        ...
        {isMenuOpen && (
          ...
          >
            <div className="flex flex-col items-center justify-center h-full gap-5">
              ...
              <button
                className="py-3 px-6 text-white  rounded-md text-sm md:text-lg border bg-secondary"
                onClick={() => {
                  setCurrentLanguage(
                    currentLanguage == RushdContent.ar
                      ? RushdContent.en
