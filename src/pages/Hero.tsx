  ...
  return (
    <div className="w-full h-screen relative overflow-hidden padding-y bg-gradient-to-r from-[#1C1C1C] via-[#1c1c1cfe] to-[#1c1c1cf8] ">
      ...
      <Helmet>
        ...
        <meta name="keywords" content="Rusd real Home Hero website estate hotel hotels Serviced apartments chalets search ksa عقارات إجارات إستراحات شقق مفروشة موقع بحث رشد وحدات خاصة شاليهات " />
      </Helmet>
      ...
      <div className="w-full h-full padding-x flex flex-col gap-5 items-center justify-center lg:flex-row xl:items-start md:pt-[20%] lg:pt-[10%] lg:justify-between">
        <div className=" max-w-full order-last lg:order-first flex flex-col items-center lg:items-start gap-8 text-white">
          ...
          <h3 className="max-w-[500px] text-center text-2xl font-semibold lg:text-left">
            ...
            <span className="bg-[#F9F5EC] p-0.5 text-black">{currentLanguage.heroData.subtitle2}</span>
          </h3>
        ...
        <div className="h-50">
          <div className="w-70 h-auto sm:w-80 xl:w-[430px] ">
            <img className="h-full w-full" src="./public/assets/white-logo.png" alt="Logo" />
          </div>
        </div>
