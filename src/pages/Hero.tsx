...
const Hero = () => {
  ...
  return (
    <div className="w-full min-h-screen h-fit pt-20 relative overflow-hidden bg-gradient-to-r from-[#1C1C1C] via-[#1c1c1cfe] to-[#1c1c1cf8] ">
      ...
      <div
        className="w-full min-h-[calc(100vh-80px)] h-fit padding-x flex flex-col justify-center gap-5 items-center lg:flex-row lg:items-center lg:justify-between"
      >
        ...
        <div data-aos={selectedLang === "ar" ? "fade-left" : "fade-right"} className="max-w-full order-last lg:order-first flex flex-col items-center lg:items-start gap-8 text-white">
          ...
          <h3 className="max-w-[500px] text-center text-2xl font-semibold lg:text-left *:p-0.5 text-secondary">
            <span>{currentLanguage.heroData.subtitle}</span>
          </h3>
